...
button.addEventListener("click", () => {
  if (button.textContent === "Click Me! ❤") {
    const googleDocsLink = "https://docs.google.com/document/d/1u2s8WlVdPbYiUDnVzgx2HRnuJNK7hv303OQ9eGo-hmk/edit?usp=sharing";

    // Open in new tab
    window.open(googleDocsLink, "_blank");

    button.textContent = "Opening your surprise... 💌";
  }
});
...
function drawText() {
    ...
    context.font = fontSize + "px Sequel Sans";
    ...
    if(frameNumber < 150){
        ...
        context.fillText("Every single dasy I am reminded of how lucky I am to have you sayang", canvas.width/2, canvas.height/2);
        opacity = opacity + 0.01;
    }
    //fades out the text by decreasing the opacity
    if(frameNumber >= 150 && frameNumber < 250){
        context.fillStyle = `rgba(45, 45, 255, ${opacity})`;
        context.fillText("Every single day I am reminded of how lucky I am to have you sayang", canvas.width/2, canvas.height/2);
        opacity = opacity - 0.01;
    }
    ...
    if(frameNumber > 1250 && frameNumber < 99999){
        ...
        if (window.innerWidth < 600) {
            drawTextWithLineBreaks(["I love you so much Aliaa, more than", "all the time and space in the universe can contain"], canvas.width / 2, canvas.height / 2, fontSize, lineHeight);
        } else {
            context.fillText("I love you so much Aliaa, more than all the time and space in the universe can contain", canvas.width/2, canvas.height/2);
        }
    ...
    if(frameNumber >= 1500 && frameNumber < 99999){
        ...
        context.fillText("Happy Valentine's Day Baby <3", canvas.width/2, (canvas.height/2 + 120));
